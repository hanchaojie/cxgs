...
*/
<template>
	<view :style="{height:navHeight+'rpx'}" class=''>
		<!-- 微信小程序头部导航栏 -->
		<!-- #ifdef MP-WEIXIN -->
		...
		<!-- 除微信小程序之外的其他设备 -->
		<!-- #ifndef MP-WEIXIN -->
		<view class="other-head-mod header" :style="{height:navHeightValue*scaleFactor+statusBarHeight+'rpx'}">
	...
	export default {
		...
		data() {
			return {
				...
				navigationBarHeight: null, //导航栏高度
				customHeight: null, //胶囊高度
				scaleFactor: null, //比例系数
				menubarLeft: null, //胶囊定位的左边left
				windowWidth: null
		...
		created() {
			...
			// console.log(SystemInfomations.statusBarHeight,'SystemInfomations.statusBarHeight')
			// console.log(SystemInfomations.scaleFactor,'SystemInfomations.scaleFactor')
