	...
	<view class="absolute">
		...
		<view class="reportBox">
			<!-- 		<view class="reportLine">
				...
				<view class="reportLine_R">
					{{allData.addvm}}{{allData.wawoName}}
			...
			<view class="reportLine">
				...
				<view class="reportLine_R">
					<!-- 	请选择
					<uni-icons type="right" size="16" color="#999999"></uni-icons> -->
					<!-- 			<u-number-box min="0" integer inputWidth="70" button-size="28" v-model="chroma"
						@change="valChange"></u-number-box> -->
					{{allData.chroma}}
				</view>
			</view>
			...
			<view class="reportLine">
				...
				<view class="reportLine_R" style="width: 200rpx;text-align: right;">
					<!-- 	请选择
					<uni-icons type="right" size="16" color="#999999"></uni-icons> -->
		...
		<view class="reportBox">
			...
			<view class="reportLine">
				...
				<view class="reportLine_R" style="display: flex;"
					:style="{'color': (allData.testStatus==1 ? 'rgba(3, 102, 241, 1)':'red')}">
					{{allData.testStatus==1?'合格':'超标'}}
					<!--  {{testStatus}}-->
					<!-- testStatus -->
					<!-- <uni-icons type="right" size="16" color="#999999"></uni-icons> -->
				</view>
...
<script>
	...
	export default {
		...
		onLoad(e) {
			console.log(e)
			this.samplingCode = e.samplingCode
			this.allData = uni.getStorageSync('samplingData')
			console.log(this.allData)
			this.querygetwqArtificialDetail(e.samplingCode)
		},
		methods: {
			querygetwqArtificialDetail(e) {
				getwqArtificialDetail(e).then(res => {
					console.log(res)
