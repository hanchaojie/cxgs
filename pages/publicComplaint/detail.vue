<template>
	<view class="absolute">
		<head-nav :style="navStyle" :navHeightValue="navHeightValue" textContent='投诉信息'></head-nav>
		...
		<view class="reportBox">
			...
			<view class="reportLine">
				...
				<view class="reportLine_R" v-if="infoDetail">
					{{infoDetail.realName ? infoDetail.realName:''}}
				</view>
			</view>
			<view class="reportLine">
				<view class="reportLine_L">
				...
				<view class="reportLine_R" v-if="infoDetail">
					{{infoDetail.addvm ? infoDetail.addvm:''}}
				</view>
			</view>
			<view class="reportLine">
				<view class="reportLine_L">
				...
				<view class="reportLine_R" v-if="infoDetail">
					{{infoDetail.source? levType(infoDetail.source):'--'}}
				</view>
			</view>
			<view class="reportLine" v-if="infoDetail">
				...
				<view class="reportLine_R">
					...
					{{infoDetail.projectName ? infoDetail.projectName:''}}
				</view>
			</view>
			...
			<textarea v-if="infoDetail" disabled class="textareaBox" name="" id="" placeholder="请输入问题描述"
...
<script>
	...
	export default {
		...
		methods: {
			getqueryDict() {
				queryDict(`?dictType=public_complaint_type`).then(Response => {
			...
			distribute() {
				uni.navigateTo({
					url: `/pages/publicComplaint/addOrderWork?complaintId=${this.complaintId}`
				})
			}
		}
